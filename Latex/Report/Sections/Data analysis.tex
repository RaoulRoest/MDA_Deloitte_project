...
\subsection{Prepayment derivation}
    ...
    \subsubsection{Prepayment in the data}
        ...
        \end{table}
        Furthermore, it is noted that in the data set, full prepayments 
        seem to appear much more often than partial prepayments.
        Also relatively, over all years there are much full prepayments.  
        For example in the year 2013, the percentage 
...
\subsection{Interest incentive}
    ...
    between 2013 an 2020. This gives us the market interest rates 
    from which the fixed interest rate of the 30 and 40 years loans 
    is derived. 
    \begin{figure}[H]
        \centering
        ...
        \label{mortgage15us}
    \end{figure}
    The Mortgages US 15 years interest rate is given by week. 
    To determine the fixed interest rate 
    per month the maximum is taken over the interest rates per week.
    As the 30 and 40 years fixed rates are derived from this 15 years
    rate, they will follow the same trent. Hence, the 15 years 
    maximum interest rate gives a good value to compare with 
    the given fixed rates. If the 15 years rate decreases, there will 
    be an incentive for the client to prepay his mortgage. 
    The aggregated values for the Mortgage US 15 years will therefore 
    be used for comparison with the fixed interest rates from the 
    clients.
    \\\\
    It is expected that when the interest rate of a loan is higher than 
    the variable interest rate corresponding at that time, and if there is 
    no penalty for prepaying, the client wants 
    to fully prepay his mortgage and close a new mortgage for the lower 
    fixed interest rate. The client must then have the resources 
    to fully pay-off his loan. When the client does not have the 
    ...
    the behavior of the interest incentive in months with no 
   ...
   % \end{table}
    ...
    debt per month. We can now take a look at the relation between this ratio 
