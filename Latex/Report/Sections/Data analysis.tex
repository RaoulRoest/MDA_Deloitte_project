...
\subsection{Prepayment derivation}
    ...
    \subsubsection{Prepayment in the data}
        ...
        amount, the payment schedule can be derived on a monthly basis. 
        Using the sheduled payments and expression \eqref{upb_part}, 
        the sheduled repayments of the UPB can be derived and 
        ...
        If the amount of repaid UPB is bigger 
