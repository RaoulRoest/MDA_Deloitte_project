...
the open source data provided by FreddieMac will be used. This data 
set contains mortgage information of the bank FreddieMac over the time interval
start 2013 until september 2020. In general the data set is  anonymized. This
will mean that there will be no personal information within the data set. However, 
data that cannot be referred to the specific persons in the data set will be included.
\\\\
...
\subsection{Data description}
    ...
    \begin{itemize}
        ...
        \item channel, prepayment penalty mortgage flag (which will be referred as "PPM"), 
    ...
    \begin{itemize}
        ...
        \item UPB, 
        \item due date of last pain instalment (DDLPI), 
        \item MI recoveries, 
        ...
        \item estimated loan to value (ELTV), 
...
\subsection{Prepayment derivation}
    ...
    \input{../PreliminaryResults/ModellingChoices/Sections/PrePaymentComputations}
